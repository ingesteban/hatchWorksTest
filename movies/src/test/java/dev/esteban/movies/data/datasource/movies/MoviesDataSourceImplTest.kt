...
class MoviesDataSourceImplTest {
    ...
    @Test
    fun `nowPlaying should call api`() =
    ...
    @Test
    fun `nowPlaying should call api with error`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `search should call api with error`() =
        runTest(testDispatcher) {
            val exception = IOException("Get now playing movies failed")
            val query = "Shadow"
    ...
    @Test
    fun `trending should call api with error`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `upcoming should call api with error`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `popular should call api with error`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `discover should call api with error`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `movieDetail should call api`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `movieDetail should call api with error`() =
        runTest(testDispatcher) {
