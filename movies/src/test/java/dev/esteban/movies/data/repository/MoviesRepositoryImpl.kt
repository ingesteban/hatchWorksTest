...
class MoviesRepositoryImplTest {
    ...
    @Test
    fun `search emits Error on exception`() = runTest {
        val query = "Batman"
    ...
    @Test
    fun `discover emits Loading then Success`() = runTest {
        val genres = "28,12"
    ...
    @Test
    fun `discover emits Error on exception`() = runTest {
        val genres = "28,12"
    ...
    @Test
    fun `movieDetail emits Loading then Success`() = runTest {
        val id = "123"
    ...
    @Test
    fun `movieDetail emits Error on exception`() = runTest {
        val id = "999"
