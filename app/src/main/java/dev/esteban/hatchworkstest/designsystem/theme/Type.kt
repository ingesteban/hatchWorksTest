...
val xlgBoldTypography: TextStyle =
    TextStyle(
...
val lgBoldTypography: TextStyle =
    TextStyle(
        fontFamily = RobotoFontFamily,
        fontWeight = FontWeight.Bold,
        fontSize = 18.sp,
...
val lgMediumTypography: TextStyle =
    TextStyle(
        fontFamily = RobotoFontFamily,
...
val mdMediumTypography: TextStyle =
    TextStyle(
        fontFamily = RobotoFontFamily,
        fontWeight = FontWeight.Medium,
        fontSize = 16.sp,
...
val mdBoldTypography: TextStyle =
    TextStyle(
        fontFamily = RobotoFontFamily,
        fontWeight = FontWeight.Bold,
        fontSize = 16.sp,
...
val mdRegularTypography: TextStyle =
    TextStyle(
        fontFamily = RobotoFontFamily,
...
val smMediumTypography: TextStyle =
    TextStyle(
        fontFamily = RobotoFontFamily,
        fontWeight = FontWeight.Medium,
        fontSize = 14.sp,
...
val smRegularTypography: TextStyle =
    TextStyle(
        fontFamily = RobotoFontFamily,
        fontWeight = FontWeight.Normal,
        fontSize = 14.sp,
